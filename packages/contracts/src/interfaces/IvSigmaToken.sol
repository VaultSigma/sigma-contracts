...
/**
 * @notice Interface for ERC20Sigma contract
 */
interface IvSigmaToken is IERC20, IERC20Permit {
    // ----------- Events -----------

    /// @notice Emitted on tokens minting
    event Minting(address indexed _minter, address indexed _to, uint256 _amount);
