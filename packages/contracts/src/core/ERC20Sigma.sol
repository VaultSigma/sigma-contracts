...
/**
 * @notice Base contract for Sigma ERC20 token
 * @notice ERC20 with:
 * - ERC20 minter, burner and pauser
 * - draft-ERC20 permit
 * - Sigma Manager access control
 */
abstract contract ERC20Sigma is
    Initializable,
    UUPSUpgradeable,
    ERC20Upgradeable,
    ...
    ERC20PausableUpgradeable
{
    ...
    modifier onlyAdmin() {
        require(
            ...
            "ERC20Sigma: not admin"
        );
        _;
    }

    /// @notice Ensures __ERC20Sigma_init cannot be called on the implementation contract
    constructor() {
    ...
    function __ERC20Sigma_init(
        ...
        __ERC20Sigma_init_unchained(_manager, symbol_);
    }

    /// @notice Initializes the current contract
    /// @param _manager Address of the manager of the contract
    /// @param symbol_ Token symbol
    function __ERC20Sigma_init_unchained(
        address _manager,
        string memory symbol_
    ) internal onlyInitializing {
        _symbol = symbol_;
